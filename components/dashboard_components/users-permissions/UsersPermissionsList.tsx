                    ...
                    <div>
                        {
                            permissions ? (  permissions.length > 0 ? <>
                                    {
                                        permissions.map((permission) =>   <span key={permission._id} className="inline-flex items-center m-2 px-2 py-1 bg-gray-200 hover:bg-gray-300 rounded-full text-sm font-semibold text-gray-600">
	<span className="ml-1">
	  ...
	  {checkPermissionActionToDisplay(permission)}
                                ...
                                </>: <span className="text-black">{`Pas de permissions ${permissions.length}`}</span>) : <span className="text-black">{`Pas de permissions`}</span>
                        }
                    </div>
                </div>
            </div>
...
export const UsersPermissionsListComponent = () => {
    ...
    const [selectedPermissions, setSelectedPermissions] = useState<Permission[] | undefined>();
    ...
    return (
        <div className="bg-gray-50 flex flex-col justify-center text-black">
            <div className="px-4 pt-4">
                <p className="mb-3 font-semibold text-2xl">Changer permissions des collaborateurs</p>
                                    ...
                                    <div className="container mx-auto mt-8">
                                        <table className="min-w-full">
                                            ...
                                            <tr className="text-gray-500">
                                                ...
                                                <th className="py-2 px-4 border-b text-start">Prénoms</th>
                                                <th className="py-2 px-4 border-b text-start">E-mail</th>
                                                <th className="py-2 px-4 border-b text-start">Téléphone</th>
                                                <th className="py-2 px-4 border-b text-center">Permissions</th>
